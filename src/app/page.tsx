          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li>
                  <a href="https://wa.me/6285198149402" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 rounded-xl border border-[#e2e8f0] bg-[#e8f6ff] px-4 py-3 text-[#0f172a] hover:border-[#25d366] hover:bg-white transition-colors">
                    ...
                    <div>
                      <p className="text-[14px] font-semibold">Hubungi Saya</p>
                      <p className="text-[12px] text-[#64748b]">WhatsApp</p>
                    </div>
                  </a>
                </li>
              </ul>
